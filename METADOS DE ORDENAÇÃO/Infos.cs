...
namespace metodosOrdenacao {
    internal class Infos {
        public string Get_informacoes(int metodo) {
            ...
            if (metodo == 0) { //se o metodo 0 for escolido, exibe info de bolha
            ...
            } else if (metodo == 1) {//se o metodo 1 for escolido, exibe info de Ordenação
            ...
            } else if (metodo == 2) {//se o metodo 2 for escolido, exibe info de INSERÇÃO
            ...
            } else if (metodo == 3) { //se o metodo 3 for escolido, exibe info de AGITAÇÃO
            ...
            } else if (metodo == 4) { //se o metodo 4 for escolido, exibe info de PENTE
            ...
            } else if (metodo == 5) { //se o metodo 5 for escolido, exibe info de SHELLSORT
            ...
            } else if (metodo == 6) { //se o metodo 6 for escolido, exibe info de Quick
            ...
            } else if (metodo == 7) {//se o metodo 7 for escolido, exibe info de heapsort 
